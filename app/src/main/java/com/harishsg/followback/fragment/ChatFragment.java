package com.harishsg.followback.fragment;
...
import com.harishsg.followback.adapter.AdapterChatList;
import com.harishsg.followback.adapter.AdapterChatListGroups;
import com.harishsg.followback.model.ModelChat;
import com.harishsg.followback.model.ModelChatListGroups;
import com.harishsg.followback.model.ModelUser;
import com.harishsg.followback.R;
import com.harishsg.followback.user.ChatUserListActivity;
import com.harishsg.followback.user.CreateGroupActivity;
import com.harishsg.followback.user.ProfileActivity;
import com.harishsg.followback.user.SearchActivity;
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot ds : snapshot.getChildren()) {
                    ...
                    recyclerView2.setAdapter(adapterChatList);
