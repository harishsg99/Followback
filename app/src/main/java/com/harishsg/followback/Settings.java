...
import com.harishsg.followback.user.EditProfileActivity;
...
public class Settings extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        invite.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String shareBody = "followback - SnapChat Clone" + " Download now on play store \nhttps://play.google.com/store/apps/details?id=com.harishsg.followback";
